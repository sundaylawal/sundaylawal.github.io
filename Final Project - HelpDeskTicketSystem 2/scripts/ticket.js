...
// this creates the form in html to input our issue
function newTicket(){
    resetNewTicketDiv();
    ...
    form.scrollIntoView(); //this method scrolls the element's parent container such that the element on which scrollIntoView() is called is visible to the user
    ...
    //drop down menu in the form to select the dept
    ...
    // drop down menu in the form to select the severity
    ...
    //the textarea for the user to input the details of the issue
    ...
    // text field in the form for the phone number
    ...
    // text field for name of the person creating the issue
    ...
    //appending the form to html so it renders
...
// THIS IS FUNCTION WILL APPLY EACH ROW, GOAL IS TO MAKE IT SO IT IS COLORED BY PRIORITY(EX. HIGH PRIORITY WILL HAVE A PINK BACKGROUND COLOR)
...
function ticketSummary(ticketNumber,ticketTitle,ticketDepartment,ticketPriority,ticketCustomerName){
    ...
    row.className = randomTableColor(); // COLOR APPLIED TO ROW HERE
    ...
    ticketAction.innerHTML= '<button class="btn-info">View Details</button>'; // TODO: MAKE A MODAL WINDOW APPEAR WHEN THIS BUTTON IS CLICKED, DISPLAYING THE ISSUE DESCRIPTION
}
function ticketSubmit(){
    ...
    // WE NEED TO FIGURE HOW TO HAVE THIS DATA BELOW SENT TO THE DATABASE
    let ticketDetails ={
    ...
    // CODE ABOVE MUST BE SENT TO DATABASE
    ...
    newOuterDiv.innerHTML = "<h1>Issue has been submitted!</h1>"
